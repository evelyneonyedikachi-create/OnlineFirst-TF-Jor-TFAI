...
export const announcementCategories = [
  ...
  'Policy Update',
  'Award / Recognition',
  'Urgent Author Communication',
] as const;

export const initialJournalAnnouncements: JournalAnnouncement[] = [
  {
    id: 'ann-1',
    title: 'Maiden Call for Papers — Volume 1, Number 1 (2026)',
    shortMessage: 'Theme: Navigating the New Era of Taxation. Original empirical manuscripts, case law treatises, and revenue policy evaluations are invited. A 30% publication fee waiver applies to all accepted maiden edition papers.',
  ...
  {
    id: 'ann-2',
    title: 'Turnitin Anti-Plagiarism Threshold (≤15%) & Review Standards',
    shortMessage: 'Editorial Board directive: All manuscripts undergo automated similarity screening. Papers exceeding the 15% threshold will be returned prior to the double-blind referee review phase.',
    category: 'Editorial Notice',
    startDate: '2026-08-01',
    endDate: '2026-11-30',
    primaryButtonText: 'View Review Protocol',
    primaryButtonUrl: 'peer-review',
    secondaryButtonText: 'Publication Ethics',
    secondaryButtonUrl: 'ethics',
    icon: 'AlertCircle',
    priority: 'urgent',
    published: true,
  ...
  {
    id: 'ann-3',
    title: 'Reviewer Panel Recruitment: Fiscal Law & Digital Taxation',
    shortMessage: 'The Joint Editorial Council of CITN Umuahia Chapter and MOUAU COLMAS invites established academics and chartered tax fellows to join our specialist peer referee registry.',
    category: 'Reviewer Recruitment',
    startDate: '2026-08-15',
    endDate: '2026-12-31',
    primaryButtonText: 'Apply to Editorial Secretariat',
    primaryButtonUrl: 'contact',
    secondaryButtonText: 'Editorial Council Profile',
    secondaryButtonUrl: 'editorial-board',
    icon: 'Users',
    priority: 'normal',
    published: true,
  ...
  {
    id: 'ann-4',
    title: 'Maiden Issue Now Published — Explore Volume 1, Issue 1',
    shortMessage: 'The inaugural volume of Tax Frontier is live online. Explore 4 peer-reviewed research treatises covering digital services taxation, informal sector presumptive compliance, and petroleum fiscal contracts.',
    ...
    icon: 'BookOpen',
    priority: 'featured',
    published: false, // Pre-configured post-launch announcement ready to be toggled in CMS
    createdAt: '2026-09-01T00:00:00Z',
  },
  {
    id: 'ann-5',
    title: 'National Tax Policy & Sub-National Revenue Mobilization Symposium',
    shortMessage: 'Joint hybrid academic-professional symposium hosted by CITN Umuahia Chapter & MOUAU COLMAS. Selected conference papers will be fast-tracked for Tax Frontier Volume 1 Issue 2.',
    category: 'Conference / Workshop',
    startDate: '2026-09-05',
    endDate: '2026-11-25',
    primaryButtonText: 'Symposium Details',
    primaryButtonUrl: 'events',
    secondaryButtonText: 'Submit Abstract',
    secondaryButtonUrl: 'call-for-papers',
    icon: 'Calendar',
    priority: 'normal',
    published: true,
  ...
  {
    id: 'ann-6',
    title: 'Crossref DOI Prefix & ISSN Verification Milestone',
    shortMessage: 'Technical publishing integration: Digital Object Identifier (DOI 10.59231/taxfront) deposit pipeline verified. Official print and online ISSN registrations confirmed in progress.',
    category: 'Indexing Milestone',
    startDate: '2026-07-20',
    endDate: '2026-12-31',
    primaryButtonText: 'Review Indexing Roadmap',
    primaryButtonUrl: 'indexing',
    icon: 'Award',
    priority: 'normal',
    published: true,
